            ...
            <ul> <a href="perfil.php?id=<?php echo $_SESSION['id'] ?>"><img onclick="atualiza(0)" src="images/pt.png" style="  width:50px; height: 20px " >
                    <a href="perfilingles.php?id=<?php echo $_SESSION['id'] ?>"><img onclick="atualizaingles(0)" src="images/eng.png" style="width: 50px; height: 20px">
                        ...
                        <?php } else{ ?>
                            ...
                            <li><a  ><button class="button special" onclick="document.getElementById('id02').style.display='block'; document.getElementById('teste001').style.overflow='hidden'" style="background-color: #aaaaaa; width:auto;">Log in</button></a></li>
                            <?php
                        }
                        ?>
            </ul>
...
?>
    ...
    <div id="titulo" style="text-align: center; width: 100%; font-weight: bold; margin-top: 2%"><h2>Edit Profile</h2></div>
    <hr>
    <form action="confirmaeditaperfil.php?id=<?php echo $dadosPerfis['perfilId'] ?>" style="color: #FFF; margin-left: 20%; margin-top: 5%;margin-bottom: 5%; width: 50%" method="post" enctype="multipart/form-data">
        <div class="mb-3">
            <label  class="badge badge-primary" style="font-size: 20px">Username: </label>
            <input  placeholder="<?php echo $dadosPerfis['perfilNome'] ?>" name="perfilNome" value="<?php echo $dadosPerfis['perfilNome'] ?>">

        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="badge badge-primary" style="font-size: 20px">Choose a new avatar:</label>
        ...
        <div class="mb-3">
            <label for="exampleInputEmail1" class="badge badge-primary" style="font-size: 20px">Choose a new banner:</label>
        ...
        <div class="mb-3">
            <label for="exampleInputEmail1" class="badge badge-primary" style="font-size: 20px">Email address:</label>
